...
class LevelGenerator {
	...
	private void setTrack(ArrayList<Location> locations, CompassHeading compassHeading1, CompassHeading compassHeading2) {
		Track startingTrack = new Track(new Connection(compassHeading1, compassHeading2));
	...
	*/
	   ...
	   public Level createLevelOne() {
	    ...
	    public Level createLevelThree() {
	        ...
	        trackLocations.add(new Location(0, 1));
	        trackLocations.add(new Location(0, 2));
	        trackLocations.add(new Location(0, 3));
	        trackLocations.add(new Location(0, 4));
	        trackLocations.add(new Location(0, 5));
	        setTrack(trackLocations, CompassHeading.EAST, CompassHeading.WEST);
